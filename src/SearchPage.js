...
import useGoodleSearch from './useGoodleSearch';
...
function SearchPage() {
    ...
    // const { data } = useGoodleSearch(term);
    const data = response;
    console.log(data);
  return (
